\documentclass[11pt]{article}
    ...
    % Document parameters
    % Document title
    \title{us-medical-insurance-costs}
...
\begin{document}
    ...
    \hypertarget{u.s.-medical-insurance-costs}{%
\section{U.S. Medical Insurance
Costs}\label{u.s.-medical-insurance-costs}}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{1}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}Project tasks:}
\PY{c+c1}{\PYZsh{}1. Find out which region has the highest and lowest charges.}
\PY{c+c1}{\PYZsh{}2. Find out which age gets charged the lowest and highest.}
\PY{c+c1}{\PYZsh{}3. Find out the difference in charges between male and female patients.}
\PY{c+c1}{\PYZsh{}4. Find the total amount of charges}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}import insurance.csv into python file, converts the csv content into python dictionary to inspect.}
\PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{insurance.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{insurance\PYZus{}sheet}\PY{p}{:}
    \PY{n}{dic\PYZus{}convert} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{insurance\PYZus{}sheet}\PY{p}{)}
    \PY{c+c1}{\PYZsh{}makes sure DictReader iterates more than once}
    \PY{n}{insurance} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{dic\PYZus{}convert}\PY{p}{)}
    \PY{n}{ages} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{sex} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{bmis} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{children} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{smokers} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{regions} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{charges} \PY{o}{=} \PY{p}{[}\PY{p}{]}

\PY{c+c1}{\PYZsh{}adding column content in named variables}
    \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{insurance}\PY{p}{:}
        \PY{n}{ages}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{age}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
        \PY{n}{sex}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{sex}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
        \PY{n}{bmis}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{bmi}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
        \PY{n}{children}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{children}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
        \PY{n}{smokers}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{smoker}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
        \PY{n}{regions}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{region}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
        \PY{n}{charges}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{charges}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
...
\{'age': '52', 'sex': 'female', 'bmi': '44.7', 'children': '3', 'smoker': 'no',
'region': 'southwest', 'charges': '11411.685'\}
\{'age': '50', 'sex': 'male', 'bmi': '30.97', 'children': '3', 'smoker': 'no',
'region': 'northwest', 'charges': '10600.5483'\}
\{'age': '18', 'sex': 'female', 'bmi': '31.92', 'children': '0', 'smoker': 'no',
'region': 'northeast', 'charges': '2205.9808'\}
\{'age': '18', 'sex': 'female', 'bmi': '36.85', 'children': '0', 'smoker': 'no',
'region': 'southeast', 'charges': '1629.8335'\}
\{'age': '21', 'sex': 'female', 'bmi': '25.8', 'children': '0', 'smoker': 'no',
'region': 'southwest', 'charges': '2007.945'\}
\{'age': '61', 'sex': 'female', 'bmi': '29.07', 'children': '0', 'smoker': 'yes',
'region': 'northwest', 'charges': '29141.3603'\}
    \end{Verbatim}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{3}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}Prints out the unique region values}
\PY{n}{unique\PYZus{}regions} \PY{o}{=} \PY{n+nb}{set}\PY{p}{(}\PY{n}{regions}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{unique\PYZus{}regions}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}Finds out the highest and lowest charges per region}
\PY{k}{def}\PY{+w}{ }\PY{n+nf}{region\PYZus{}charges}\PY{p}{(}\PY{n}{regions}\PY{p}{,} \PY{n}{charges}\PY{p}{)}\PY{p}{:}
    \PY{n}{combined\PYZus{}list} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n+nb}{zip}\PY{p}{(}\PY{n}{regions}\PY{p}{,} \PY{n}{charges}\PY{p}{)}\PY{p}{)}
    \PY{n}{total\PYZus{}charges} \PY{o}{=} \PY{l+m+mi}{0}
    \PY{n}{nw\PYZus{}charges} \PY{o}{=} \PY{l+m+mi}{0}
    \PY{n}{ne\PYZus{}charges} \PY{o}{=} \PY{l+m+mi}{0}
    \PY{n}{sw\PYZus{}charges} \PY{o}{=} \PY{l+m+mi}{0}
    \PY{n}{se\PYZus{}charges} \PY{o}{=} \PY{l+m+mi}{0}

    \PY{k}{for} \PY{n}{region}\PY{p}{,} \PY{n}{charge} \PY{o+ow}{in} \PY{n}{combined\PYZus{}list}\PY{p}{:}
        \PY{c+c1}{\PYZsh{}Finds the total amount of charges for all regions}
        \PY{n}{total\PYZus{}charges} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{charge}\PY{p}{)}
        \PY{c+c1}{\PYZsh{}Adds respective charges to regions}
        \PY{k}{if} \PY{n}{region} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{northwest}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
            \PY{n}{nw\PYZus{}charges} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{charge}\PY{p}{)}
        \PY{k}{elif} \PY{n}{region} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{northeast}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
            \PY{n}{ne\PYZus{}charges} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{charge}\PY{p}{)}
        \PY{k}{elif} \PY{n}{region} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{southwest}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
            \PY{n}{sw\PYZus{}charges} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{charge}\PY{p}{)}
        \PY{k}{elif} \PY{n}{region} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{southeast}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
            \PY{n}{se\PYZus{}charges} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{charge}\PY{p}{)}

    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{The total amount of charges is }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{total\PYZus{}charges}\PY{p}{)}\PY{p}{)}

    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}\PYZsq{}\PYZsq{}}\PY{l+s+s1}{The charges for the Northeastern region is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ }
\PY{l+s+s1}{The charges for the Northwestern region is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ }
\PY{l+s+s1}{The charges for the Southeastern region is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ }
\PY{l+s+s1}{The charges for the Southwestern region is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}\PYZsq{}\PYZsq{}}\PY{o}{.}
          \PY{n+nb}{format}\PY{p}{(}\PY{n}{ne\PYZus{}charges}\PY{p}{,} \PY{n}{nw\PYZus{}charges}\PY{p}{,} \PY{n}{se\PYZus{}charges}\PY{p}{,} \PY{n}{sw\PYZus{}charges}\PY{p}{)}\PY{p}{)}  

\PY{n}{region\PYZus{}charges}\PY{p}{(}\PY{n}{regions}\PY{p}{,} \PY{n}{charges}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}prints out the unique ages}
\PY{n}{ages} \PY{o}{=} \PY{p}{[}\PY{p}{]}
\PY{n}{count} \PY{o}{=} \PY{l+m+mi}{0}
\PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{insurance}\PY{p}{:}
    \PY{n}{ages}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{age}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\PY{n}{unique\PYZus{}ages} \PY{o}{=} \PY{n+nb}{set}\PY{p}{(}\PY{n}{ages}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{unique\PYZus{}ages}\PY{p}{)}
\PY{k}{for} \PY{n}{age} \PY{o+ow}{in} \PY{n}{unique\PYZus{}ages}\PY{p}{:}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
\{'25', '39', '36', '53', '18', '46', '63', '54', '57', '60', '58', '22', '34',
'59', '61', '48', '20', '33', '26', '51', '50', '56', '31', '28', '38', '62',
'41', '40', '24', '23', '52', '49', '43', '21', '64', '45', '30', '47', '29',
'27', '42', '32', '37', '19', '55', '35', '44'\}
47
    \end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def}\PY{+w}{ }\PY{n+nf}{age\PYZus{}charges}\PY{p}{(}\PY{n}{ages}\PY{p}{,} \PY{n}{charges}\PY{p}{)}\PY{p}{:}
    \PY{n}{combined\PYZus{}list} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n+nb}{zip}\PY{p}{(}\PY{n}{ages}\PY{p}{,} \PY{n}{charges}\PY{p}{)}\PY{p}{)}
    \PY{n}{unique\PYZus{}ages} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{34}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{29}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{35}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{25}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{50}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{55}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{64}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{52}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{53}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{21}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} 
               \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{39}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{44}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{47}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{51}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{27}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{22}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{62}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{19}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{33}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{28}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} 
               \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{49}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{23}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{31}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{43}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{42}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{61}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{26}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{37}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{54}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{20}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} 
               \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{45}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{56}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{36}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{46}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{30}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{58}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{57}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{38}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{59}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{48}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} 
               \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{41}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{18}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{60}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{63}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{32}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{24}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{40}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+m+mi}{0}\PY{p}{\PYZcb{}}
    \PY{k}{for} \PY{n}{age}\PY{p}{,} \PY{n}{charges} \PY{o+ow}{in} \PY{n}{combined\PYZus{}list}\PY{p}{:}
        \PY{k}{if} \PY{n}{age} \PY{o+ow}{in} \PY{n}{unique\PYZus{}ages}\PY{p}{:}
            \PY{n}{unique\PYZus{}ages}\PY{p}{[}\PY{n}{age}\PY{p}{]} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{charges}\PY{p}{)}

\PY{c+c1}{\PYZsh{}Prints out a tuple containing ages and their respective charges}
    \PY{c+c1}{\PYZsh{} for i in unique\PYZus{}ages.items():}
    \PY{c+c1}{\PYZsh{}      print(i)}

\PY{c+c1}{\PYZsh{}Finds the age with the maximum and minimum charges}
    \PY{n}{max\PYZus{}charge} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{unique\PYZus{}ages}\PY{p}{,} \PY{n}{key} \PY{o}{=} \PY{n}{unique\PYZus{}ages}\PY{o}{.}\PY{n}{get}\PY{p}{)}
    \PY{n}{min\PYZus{}charge} \PY{o}{=} \PY{n+nb}{min}\PY{p}{(}\PY{n}{unique\PYZus{}ages}\PY{p}{,} \PY{n}{key} \PY{o}{=} \PY{n}{unique\PYZus{}ages}\PY{o}{.}\PY{n}{get}\PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{The age with the most charges of }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}
          \PY{n+nb}{format}\PY{p}{(}\PY{n}{unique\PYZus{}ages}\PY{p}{[}\PY{n}{max\PYZus{}charge}\PY{p}{]}\PY{p}{,} \PY{n}{max\PYZus{}charge}\PY{p}{)}\PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{The age with the least charges of }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}
          \PY{n+nb}{format}\PY{p}{(}\PY{n}{unique\PYZus{}ages}\PY{p}{[}\PY{n}{min\PYZus{}charge}\PY{p}{]}\PY{p}{,} \PY{n}{min\PYZus{}charge}\PY{p}{)}\PY{p}{)}
    
\PY{n}{age\PYZus{}charges}\PY{p}{(}\PY{n}{ages}\PY{p}{,} \PY{n}{charges}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def}\PY{+w}{ }\PY{n+nf}{gender\PYZus{}charge\PYZus{}difference}\PY{p}{(}\PY{n}{sex}\PY{p}{,} \PY{n}{charges}\PY{p}{)}\PY{p}{:}
    \PY{n}{combined\PYZus{}list} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n+nb}{zip}\PY{p}{(}\PY{n}{sex}\PY{p}{,} \PY{n}{charges}\PY{p}{)}\PY{p}{)}
    \PY{n}{total\PYZus{}male\PYZus{}charge} \PY{o}{=} \PY{l+m+mi}{0}
    \PY{n}{total\PYZus{}female\PYZus{}charge} \PY{o}{=} \PY{l+m+mi}{0}

    \PY{c+c1}{\PYZsh{}Find the total amount of charges for both male and female}
    \PY{k}{for} \PY{n}{sex}\PY{p}{,} \PY{n}{charge} \PY{o+ow}{in} \PY{n}{combined\PYZus{}list}\PY{p}{:}
        \PY{k}{if} \PY{n}{sex} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{male}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
            \PY{n}{total\PYZus{}male\PYZus{}charge} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{charge}\PY{p}{)}
        \PY{k}{else}\PY{p}{:}
            \PY{n}{total\PYZus{}female\PYZus{}charge} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{charge}\PY{p}{)}

    \PY{c+c1}{\PYZsh{}Finds the difference b/w male and female charges}
    \PY{n}{charge\PYZus{}difference} \PY{o}{=} \PY{n}{total\PYZus{}male\PYZus{}charge} \PY{o}{\PYZhy{}} \PY{n}{total\PYZus{}female\PYZus{}charge}
    
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{The total amount of charges for the male sex = }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{total\PYZus{}male\PYZus{}charge}\PY{p}{)}\PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{The total amount of charges for the female sex = }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{total\PYZus{}female\PYZus{}charge}\PY{p}{)}\PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{The difference between the male and female charges is }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{charge\PYZus{}difference}\PY{p}{)}\PY{p}{)}
\PY{n}{gender\PYZus{}charge\PYZus{}difference}\PY{p}{(}\PY{n}{sex}\PY{p}{,} \PY{n}{charges}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
